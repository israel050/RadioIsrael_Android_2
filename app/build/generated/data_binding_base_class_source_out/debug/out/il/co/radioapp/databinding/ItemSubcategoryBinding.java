...
public final class ItemSubcategoryBinding implements ViewBinding {
  ...
  private ItemSubcategoryBinding(@NonNull LinearLayout rootView, @NonNull TextView tvSubcategory) {
  ...
  public static ItemSubcategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSubcategoryBinding((LinearLayout) rootView, tvSubcategory);
    }
